...
export default function Home() {
  return <>
    <SiteHeader />
    <main id="main-content" className="mx-auto max-w-7xl px-5 pb-12 pt-9 sm:px-10 lg:pt-14">
      <div className="grid items-start gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-14">
        <section aria-labelledby="welcome-heading" className="pt-2 lg:sticky lg:top-10 lg:pt-8">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-kampung-red">Kampung Connect · Pek Kio</p>
          <h1 id="welcome-heading" className="mt-5 max-w-xl text-[2.8rem] font-semibold leading-[1.08] tracking-tight sm:text-6xl xl:text-7xl">Find your<br /><span className="text-kampung-red">kampung spirit.</span></h1>
          <p className="mt-6 max-w-lg text-lg leading-8 text-muted">A family recipe. A game of chess. A neighbour who becomes a friend.</p>
          <p className="mt-4 max-w-lg text-base leading-8 text-muted">Pek Kio has so much to share. Connect with neighbours of another generation to teach, learn, or enjoy an activity together.</p>
          ...
          <div className="mt-9 hidden max-w-sm border-l-4 border-kampung-orange pl-5 lg:block"><p className="text-lg font-medium leading-8">“Come for the activity.<br />Stay for the company.”</p><p className="mt-3 text-xs leading-6 text-muted">Around your block. Across generations.<br />At Pek Kio Community Centre.</p></div>
        </section>
        <RequestForm />
      </div>
      <section id="how-it-works" aria-labelledby="how-heading" className="mt-16 scroll-mt-8 border-t border-line pt-10 lg:mt-20">
        ...
        <h2 id="how-heading" className="mt-3 text-3xl font-semibold tracking-tight">A little closer, in three steps.</h2>
